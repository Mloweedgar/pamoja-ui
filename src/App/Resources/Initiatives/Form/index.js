    ...
    fetchInitiativeTypes()
      ...
      getFocalPeople()
        .then(res => {
            ...
            this.setState({focalPeople: res.data.data})
        });
  ...
  render() {
    ...
    return (
        <Form
            ...
            initialValues={{
              actor_type_id: selected?.actor_type.id,
              ...
              funding_organisations: selected?.funding_organisations.map(
                  (organisation) => organisation.id
              ),
              location_id: selected?.location.id,
              initiative_type_id: selected?.initiative_type.id,
              focal_person_id: selected?.focal_person.id,
