...
class MapDashboard extends  Component {
    ...
    displayRemoteLayers() {
        ...
        const Drone_images  = L.tileLayer.wms("https://geonode.resilienceacademy.ac.tz/geoserver/ows", {
            layers: 'geonode:msimbazi_merged_transparent_mosaic_group1',
            format: 'image/png',
            transparent: true,
        });
        ...
        L.control.layers({}, {
            ...
            "Drone_images_for_lower_Msimbazi_Valley": Drone_images ,
            "Satellite": googleSat ,
            ...
            <div className="MapDashboard">
                ...
                >
                    <List
                        ...
                        renderItem={item => <List.Item><MapDetailItem item={item} activeMapSideMenuItem={activeMapSideMenuItem}/></List.Item>}
                    />
                </Drawer>
            </div>
